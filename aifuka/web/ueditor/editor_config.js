...
(function () {
  ...
  //  var tmp = window.location.pathname,URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");
    ...
    UEDITOR_CONFIG = {
        ...
        toolbars:[
            [ 'Source','|',
                ...
                'Link', 'Unlink', 'Anchor', '|', 'ImageNone', 'ImageLeft', 'ImageRight', 'ImageCenter', '|', 'InsertImage', 'Emotion', 'InsertVideo', 'Attachment', 'Map', 'GMap', 'PageBreak', 'HighlightCode', '|',
                'Horizontal' ]
        ],
